...
MODEL_NAME_SMALL = "bigscience/bloom-560m"

tokenizer_7b = AutoTokenizer.from_pretrained(MODEL_NAME_SMALL)

model_7b = AutoModelForCausalLM.from_pretrained(MODEL_NAME_SMALL)
